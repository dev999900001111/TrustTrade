...
Please extract ContextMappings from the domain model.
...
[{"type": "${Partnership|SharedKernel|CustomerSupplier|Conformist|AnticorruptionLayer|OpenHostService|PublishedLanguage}","source": "${BoundedContextName}","target": "${BoundedContextName}",}]
