...
@Service
public class RewardCalculationServiceImpl {
...
Please understand the contents of Requirements and Domain Models and write the implementation of all methods of Base Code "RewardCalculationService".
The target is as follows.
- calculateReward, calculateFee, createPaymentHistory, getPaymentHistory
